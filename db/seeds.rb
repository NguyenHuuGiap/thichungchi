...
Category.create! name: "Lich su hinh thanh", description: "Lich su hinh thanh", pattern: 0, parent: gioithieu.id
...
Category.create! name: "Danh Nhan Lich Su", description: "Danh nhan lich su noi tieng", pattern: 0, parent: lichsu.id
...
Category.create! name: "Thông Báo Hoạt Động", description: "Thông Báo Hoạt Động", pattern: 1
